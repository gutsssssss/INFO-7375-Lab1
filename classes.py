...
class Model:
    ...
    def init_layers(self):
        ...
        # Develop a Multilayer Neural Network @lab1 task1
    ...
    def workLine(self, x: torch.Tensor, true_labels: torch.Tensor, test: bool = False):
        ...
        # labels represent the images are "0" (label 0)or not "0"(label 1) @ lab1 task2
        y_true = torch.where(true_labels > 0, torch.tensor(1), true_labels)
